...
def test_mail_focus_from_plan_uses_batch(tmp_path, monkeypatch):
    """Bulk focus via plan file should issue $batch envelopes."""
    import json
    import httpx
    ...
    monkeypatch.setattr("m365ctl.mail.cli.focus.GraphClient", factory)
    ...
    monkeypatch.setattr(
        "m365ctl.mail.cli.focus.load_and_authorize",
    ...
    from m365ctl.mail.cli.focus import main as focus_main
